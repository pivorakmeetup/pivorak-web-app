...
ActiveRecord::Schema.define(version: 20180430133719) do
  ...
  create_table "courses_homeworks", force: :cascade do |t|
    ...
    t.index ["lecture_id"], name: "index_courses_homeworks_on_lecture_id", using: :btree
  ...
  create_table "courses_lectures", force: :cascade do |t|
    ...
    t.integer  "season_id"
    t.integer  "mentor_id"
    t.index ["mentor_id"], name: "index_courses_lectures_on_mentor_id", using: :btree
  ...
  create_table "courses_students", force: :cascade do |t|
    ...
    t.text     "devote_info"
    t.index ["user_id"], name: "index_courses_students_on_user_id", using: :btree
  end
