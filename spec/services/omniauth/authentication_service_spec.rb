...
RSpec.describe ::Omniauth::AuthenticationService do
  ...
  describe '#authenticate' do
    context 'with valid params' do
      ...
      it 'returns a valid instance of User class', :aggregate_failures do
        expect(result).to be_an_instance_of User
        expect(result.valid?).to eq true
      end

      it 'assigns email, first_name, last_name and password to the instance', :aggregate_failures do
      ...
      it 'links identity to the instance', :aggregate_failures do
        result
        expect(identity).not_to be_nil
        expect(identity.user).to eq result
      end

      it 'assigns uid and provider attributes to the identity', :aggregate_failures do
        result
