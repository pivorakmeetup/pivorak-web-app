...
describe Courses::Student::TotalHash do
  ...
  let!(:first_progress)  do
    create(
      :progress, student: first_student, lecture: first_lecture, homework_mark: 2, lecture_presence: -1
    )
  end
  let!(:second_progress) do
    create(
      :progress, student: second_student, lecture: first_lecture, homework_mark: 1.5, lecture_presence: 0
    )
  end
  let!(:third_progress) do
    create(
      :progress, student: first_student, lecture: second_lecture, homework_mark: -1, lecture_presence: 1
    )
  end
  let!(:fourth_progress) do
    create(
      :progress, student: second_student, lecture: second_lecture, homework_mark: 1, lecture_presence: 0
    )
  end
