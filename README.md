...
3. Checkout new branch with name "#{issue_id}-#{add or fix or improve}-#{job-done-description}", **write tests**, write code, compose nice commit message "#{issue-id} commit message text" (you may use emoji) and push your branch to origin.
